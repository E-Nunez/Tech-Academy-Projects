...
namespace TwentyOne
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //File.WriteAllText(@"C:\Users\ericn\Logs\log.txt", text);

            //string text = File.ReadAllText("C:\\Users\\ericn\\Logs\\log.txt");

            //DateTime yearOfBirth = new DateTime(1995, 4, 11, 8, 32, 45);
            ...
            if (answer == "yes" || answer == "yeah" || answer == "y" || answer == "ya")
            {
                ...
                using (StreamWriter file = new StreamWriter(@"C:\Users\ericn\Logs\log.text", true))
                {
